...
- **View**: Switch to the `v2-single-file-approach` branch to see the alternative implementation

Both approaches implement the same physics and gameplay mechanics but with different architectural philosophies.
